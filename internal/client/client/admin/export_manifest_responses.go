...
func (o *ExportManifestReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /admin/manifest] ExportManifest", response, response.Code())
	}
}
...
// Code gets the status code for the export manifest o k response
func (o *ExportManifestOK) Code() int {
	return 200
}

func (o *ExportManifestOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /admin/manifest][%d] exportManifestOK %s", 200, payload)
}
...
// Code gets the status code for the export manifest unauthorized response
func (o *ExportManifestUnauthorized) Code() int {
	return 401
}

func (o *ExportManifestUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /admin/manifest][%d] exportManifestUnauthorized %s", 401, payload)
}
...
// Code gets the status code for the export manifest not found response
func (o *ExportManifestNotFound) Code() int {
	return 404
}

func (o *ExportManifestNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /admin/manifest][%d] exportManifestNotFound %s", 404, payload)
}
...
// Code gets the status code for the export manifest internal server error response
func (o *ExportManifestInternalServerError) Code() int {
	return 500
}

func (o *ExportManifestInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /admin/manifest][%d] exportManifestInternalServerError %s", 500, payload)
}
