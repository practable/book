...
type ClientService interface {
	...
	BeginOperationalHealthCheck(params *BeginOperationalHealthCheckParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*BeginOperationalHealthCheckAccepted, error)
...
/*
BeginOperationalHealthCheck reserves a resource and run its manifest approved stream health pipeline
*/
func (a *Client) BeginOperationalHealthCheck(params *BeginOperationalHealthCheckParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*BeginOperationalHealthCheckAccepted, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewBeginOperationalHealthCheckParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "BeginOperationalHealthCheck",
		Method:             "POST",
		PathPattern:        "/admin/resources/{resource_name}/streams/{stream_name}/health-checks",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json", "text/plain"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &BeginOperationalHealthCheckReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*BeginOperationalHealthCheckAccepted)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for BeginOperationalHealthCheck: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
*/
func (a *Client) GetOperationalStatus(params *GetOperationalStatusParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetOperationalStatusOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetOperationalStatusParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetOperationalStatus",
		Method:             "GET",
		PathPattern:        "/admin/operations",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json", "text/plain"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &GetOperationalStatusReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*GetOperationalStatusOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for GetOperationalStatus: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
