...
type Manifest struct {
	...
	OperationalJobTemplates      map[string]OperationalJobTemplate      `json:"operational_job_templates,omitempty" yaml:"operational_job_templates,omitempty"`
	OperationalPipelineTemplates map[string]OperationalPipelineTemplate `json:"operational_pipeline_templates,omitempty" yaml:"operational_pipeline_templates,omitempty"`
...
type Resource struct {
	...
	StreamOperations map[string]OperationalStreamBinding `json:"stream_operations,omitempty" yaml:"stream_operations,omitempty"`
...
type Store struct {
	*sync.RWMutex `json:"-"`
	...
	OperationalJobTemplates      map[string]OperationalJobTemplate
	OperationalPipelineTemplates map[string]OperationalPipelineTemplate
...
func New() *Store {
	...
	return &Store{
		...
		make(map[string]OperationalJobTemplate),
		make(map[string]OperationalPipelineTemplate),
...
func (s *Store) exportManifestLocked() Manifest {
	...
	return Manifest{
		...
		OperationalJobTemplates:      s.OperationalJobTemplates,
		OperationalPipelineTemplates: s.OperationalPipelineTemplates,
		Resources:                    rm,
		Slots:                        s.Slots,
		Streams:                      s.Streams,
		UIs:                          uis,
...
func (s *Store) applyManifestLocked(m Manifest) error {
	...
	s.OperationalJobTemplates = m.OperationalJobTemplates
	s.OperationalPipelineTemplates = m.OperationalPipelineTemplates
	s.Slots = m.Slots
	s.Streams = m.Streams
	s.UIs = uis
	s.UISets = m.UISets
