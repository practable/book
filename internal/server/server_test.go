...
func TestLockedToUser(t *testing.T) {
	...
	tests := map[string]struct {
		...
		"GetDescriptionLockedUserAllowed":            {locked, getDescription, authUser, true, `[GET /descriptions/{description_name}][200] getDescriptionOK`},
		...
		"GetPolicyLockedUserAllowed":                 {locked, getPolicy, authUser, true, `[GET /policies/{policy_name}][200] getPolicyOK`},
		...
		"GetAvailabilityLockedUserAllowed":           {locked, getAvailability, authUser, true, `[GET /slots/{slot_name}][200] getAvailabilityOK`},
		...
		"MakeBookingLockedAdminDenied":               {locked, makeBooking, authAdmin, false, `[POST /slots/{slot_name}][404] makeBookingNotFound`},
		...
		"GetBookingsForUserLockedUserAllowed":        {locked, getBookingsForUser, authUser, true, `[GET /users/{user_name}/bookings][200] getBookingsForUserOK`},
		...
		"CancelBookingLockedUserAllowed":             {locked, cancelBooking, authUser, false, `[DELETE /users/{user_name}/bookings/{booking_name}][404] cancelBookingNotFound`},
		...
		"GetActivityLockedUserAllowed":               {locked, getActivity, authUser, true, `[PUT /users/{user_name}/bookings/{booking_name}][200] getActivityOK`},
		...
		"GetOldBookingsForUserLockedUserAllowed":     {locked, getOldBookingsForUser, authUser, true, `[GET /users/{user_name}/oldbookings][200] getOldBookingsForUserOK`},
		...
		"GetGroupsForUserLockedUserAllowed":          {locked, getGroupsForUser, authUser, true, `[GET /users/{user_name}/groups][200] getGroupsForUserOK`},
		...
		"GetPolicyStatusForUserLockedUserAllowed":    {locked, getPolicyStatusForUser, authUser, true, `[GET /users/{user_name}/policies/{policy_name}][200] getPolicyStatusForUserOK`},
		...
		"AddGroupForUserLockedUserAllowed":           {locked, addGroupForUser, authUser, true, `[POST /users/{user_name}/groups/{group_name}][204] addGroupForUserNoContent`},
