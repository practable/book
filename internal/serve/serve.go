...
func API(ctx context.Context, config config.ServerConfig, cancelOthers func()) {
	...
	api.AdminListOperationalAlertsHandler = admin.ListOperationalAlertsHandlerFunc(listOperationalAlertsHandler(config))
	...
	api.AdminMakeMaintenanceBookingHandler = admin.MakeMaintenanceBookingHandlerFunc(makeMaintenanceBookingHandler(config))
	api.AdminMakeResourceMaintenanceBookingHandler = admin.MakeResourceMaintenanceBookingHandlerFunc(makeResourceMaintenanceBookingHandler(config))
	api.AdminOverrideCancelBookingHandler = admin.OverrideCancelBookingHandlerFunc(overrideCancelBookingHandler(config))
	...
	api.AdminReplaceBookingHandler = admin.ReplaceBookingHandlerFunc(replaceBookingHandler(config))
