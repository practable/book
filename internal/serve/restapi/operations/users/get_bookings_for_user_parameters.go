...
// GetBookingsForUserParams contains all the bound params for the get bookings for user operation
...
func (o *GetBookingsForUserParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetBookingsForUserParams) bindUserName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
