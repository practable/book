...
func (o *MakeBookingURL) Build() (*url.URL, error) {
	...
	if slotName != "" {
		...
		return nil, errors.New("slotName is required on MakeBookingURL")
	}
...
func (o *MakeBookingURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on MakeBookingURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on MakeBookingURL")
	}
