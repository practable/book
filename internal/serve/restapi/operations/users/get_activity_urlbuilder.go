...
func (o *GetActivityURL) Build() (*url.URL, error) {
	...
	if bookingName != "" {
		...
		return nil, errors.New("bookingName is required on GetActivityURL")
	}
	...
	if userName != "" {
		...
		return nil, errors.New("userName is required on GetActivityURL")
	}
...
func (o *GetActivityURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetActivityURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetActivityURL")
	}
