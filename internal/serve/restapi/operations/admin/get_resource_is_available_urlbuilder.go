...
func (o *GetResourceIsAvailableURL) WithBasePath(bp string) *GetResourceIsAvailableURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetResourceIsAvailableURL) Build() (*url.URL, error) {
	...
	if resourceName != "" {
		...
		return nil, errors.New("resourceName is required on GetResourceIsAvailableURL")
	}
...
func (o *GetResourceIsAvailableURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetResourceIsAvailableURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetResourceIsAvailableURL")
	}
