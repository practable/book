...
func (o *CheckManifestURL) Build() (*url.URL, error) {
	...
	var _path = "/admin/manifest/check"
...
func (o *CheckManifestURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CheckManifestURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CheckManifestURL")
	}
